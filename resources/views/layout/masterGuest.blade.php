...
<!DOCTYPE html>
    ...
    <head>
        ...
        <link type="text/css" href="{{ asset('css/guest/catalogo.css') }}" rel="stylesheet">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarPaginas">
                            <div class="navbar-nav mr-auto">
                                <li>
                                    <a id="nav-producto" class="nav-link active" style="color: #a6ddb6" href="{{ route("catalogo") }}" >Productos</a>
                                </li>
                            </div>
                        </div>
                        <div class="navbar-nav d-flex mt-1">
                            <a href="{{route('vendedor.login')}}" class="btn btn-outline-info" style=" font-size: 9pt"> iniciar sesion</a>
                        </div>
                    </div>
                </nav>
