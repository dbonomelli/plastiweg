...
<section class="appointment-area">
    <div class="container-fluid">
        <div class="row text-center">
            <div class="col-auto">
                <a href="{{ route('cotizaciones.create') }}" class="btn btn-warning">Cancelar</a>
            </div>
            <div class="col">
...
<script>
    function onChangeRegion(valor){
        location.href='?valor='+valor+'&rut='+$('#rut').val()+'&nombre='+$('#nombre').val()+'&apellido='+$('#apellido').val()+'&telefono='+$('#telefono').val()+'&email='+$('#email').val(); 
    }
